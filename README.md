...
- **🏆 週末重賞・G1展望**: netkeiba ニュース・JRA お知らせ・サンスポZBAT!・東スポ競馬・スポーツ報知
- **🐎 注目馬・調教・厩舎**: ラジオNIKKEI 競馬・デイリースポーツ・スポニチ・日刊スポーツ
- **🌱 POG・2歳・血統**: netkeiba コラム・JBIS-Search・JRA-VAN コラム
- **🌍 海外競馬**: Racing Post・BloodHorse・JAIRS・Thoroughbred Daily News
- **📰 競馬界ニュース**: NAR 地方競馬・Yahoo!ニュース 競馬・競馬ラボ

※ 各 RSS URL はサイト改編で死ぬことがあるため、週次改善ルーチンが運用ログから死活を判定し、
差し替え PR を出す設計。初回起動時は `npm run fetch` で生存しているソースだけが拾われる。
